        ...
        <div className=" hero_center d-flex ali min-vh100 hero_custom_height align-items-center justify-content-center">
          <div className=" container ">
            <div className=" text-center">
              <h1 className=" text-center fw-bold fs_3xl ff_poppins lh_mainHeading mx-auto">
                Lorem ipsum Lorem ipsum
              </h1>
              <p className=" ff_poppins fw-normal fs_sm  mx-auto pt-2 max_w_hero_par mx-auto lh_All_par">
              ...
              <button className="ff_poppins fw-normal fs_sm  mx-auto  button_btn mt-3 button_lh">
                Button
              </button>
            </div>
          </div>
