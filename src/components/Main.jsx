  ...
  return (
    <>
      <div className="pt-5 d-flex align-items-center flex-wrap gap-4 justify-content-center">
        ...
        <a
          href="/header"
          className="py-2 px-4 text-decoration-none bg-info border-0 text-white"
        >
          Header
        </a>
        ...
        <a
          href="/footer"
          className="py-2 px-4 text-decoration-none bg-info border-0 text-white text-decoration-none"
        >
          Footer
        </a>
        <a
